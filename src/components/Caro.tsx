    ...
    // Slide 3 - Mobile Layout
    {
      ...
      content: {
        leftSection: [
          {
            badge: "SPONSORED",
            title: "Spotify Premium Subscripton",
            price: "14.99 USD",
            tag: "GLOBAL",
          ...
          },
          {
            ...
            image: "https://assets.nintendo.com/image/upload/q_auto:eco/f_auto/dpr_1.25/ncom/software/switch-2/70010000095431/b8ca3bbb06f7a4149bea701e6764ed302b9ec0b41b3d7137d52eddb6ed05d704",
          },
          {
            badge: "SPONSORED",
  ...
  const renderMobileSlideDesktop = (slide) => (
    <div className="bg-gray-900 text-white p-8 min-h-[500px]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-8 h-[400px] mt-10">
          {/* Left Section - Game Cards */}
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm text-green-400 font-medium">{game.tag}</span>
                      {/* {game.platforms && (
