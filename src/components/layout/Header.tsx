...
export function Header() {
  ...
  const [isHamburgerDisabled, setIsHamburgerDisabled] = useState(true); // Initially disabled
            ...
            <div className="flex items-center h-14 px-3 gap-2">
              ...
              <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                <SheetTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-8 w-8 p-0 flex-shrink-0" disabled={isHamburgerDisabled}>
